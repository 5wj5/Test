...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        InputStream input = Test.class.getClassLoader().getResourceAsStream("123.xlsx");
...
//                    row.getCell(j).setCellValue("wj");
//                } else {
//                }
//                if ("`HISTORY_PRESENT_ILLNESS`".equals(row.getCell(0))){
//                    System.out.println();
//                }
//            }
//            row.setRowStyle();
...
//                    String wj = row.getCell(4).getStringCellValue();
//                    if ("Y".equals(row.getCell(4).getStringCellValue())) {
//                        nullSql = " not null";
//                    }
//                    if (row.getCell(4).getStringCellValue().replace(" ", "").equals("")) {
...
//                把这两个值赋值一样
                ...
                String rowNewCellName = row.getCell(0).getStringCellValue().replace(" ", "").replace("\t", "");
...
//                            可能是否为空那项不存在 所以要判断
                            if (next.getCell(2) != null) {
                                ...
                                System.out.println("字段：" + newCell + " sql类型：" + next.getCell(1).getStringCellValue().replace(" ", "") +
